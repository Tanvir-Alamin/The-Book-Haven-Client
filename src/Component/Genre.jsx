...
const Genre = () => {
  ...
  const Genres = fetch("/public/genres.json")
    .then((res) => res.json())
  ...
  return (
    <div className="py-25">
      ...
      <div className="grid grid-cols-2 mx-15 md:grid-cols-3  gap-10">
        {gen.map((result) => (
          <div className="flex   p-5 rounded-3xl shadow-xl shadow-pink-200 bg-pink-50 transition-transform hover:shadow-2xl hover:border-pink-800 duration-300 hover:scale-110  gap-2 items-center flex-col text-center justify-center">
